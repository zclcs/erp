...
public class WaterMarkEventHandler implements IEventHandler {
    ...
    public WaterMarkEventHandler(String waterMarkContent, PdfFont pdfFont) {
        this(waterMarkContent, pdfFont, 5, 5);
    }

    public WaterMarkEventHandler(String waterMarkContent, PdfFont pdfFont, int waterMarkX, int waterMarkY) {
