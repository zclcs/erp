...
<div class="layui-container">
    <div class="layui-row">
        ...
        <h3 style="text-align: center;">${year}${deliveryDateString}对账单</h3>
        <p style="text-align: left;">客户：${companyName}</p>
        <div class="layui-col-md-offset-3 layui-col-md-6">
            <table class="layui-table" lay-size="sm" style="text-align: center;">
                ...
                <#list billList as bill>
                    <tr>
                        <td>${bill.deliveryDate!}</td>
                        <td>${bill.productName!}</td>
                        <td>${bill.specificationString!}</td>
                        <td>${bill.number!}</td>
                        <td>${bill.price!}</td>
                        <td>${bill.amount!}</td>
                        <td>&nbsp;${bill.remark!}</td>
